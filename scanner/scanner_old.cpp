...
int main(int argc, char *argv[])
{
  ...
  // header intro
  wayland_hpp << std::format(
    "#pragma once"
    "#include {}"
    , server ? "<thin_wayland_server.hpp>" : "<thin_wayland_client.hpp>");
   ...
   "#pragma once" << std::endl
            ...
            //   << (server ? "#include <wayland-server.hpp>" : "#include <wayland-client.hpp>") << std::endl;
              << (server ? "#include <thin_wayland_server.hpp>" : "#include <thin_wayland_client.hpp>") << std::endl;
